                        ...
                        <table class="table table-hover table-vcenter mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('service.stats.service_name') }}</th>
                                    <th>{{ __('service.stats.stage') }}</th>
                                    <th>{{ __('service.stats.unit') }}</th>
                                    <th class="text-end">{{ __('service.stats.quantity_done') }}</th>
                                    <th class="text-end">{{ __('service.stats.money_payable') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-4">{{ __('service.stats.empty') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                            <tfoot>
                                <tr class="fw-bold">
                                    <td colspan="5" class="text-end">{{ __('service.stats.grand_total') }}</td>
