{{--
  Standard CRUD list, with the whole client row acting as the expand/collapse
  trigger for the details row (payments + orders sub-lists).
--}}
@extends('crud::list')
...
<script>
    jQuery(document).ready(function ($) {
        ...
        // Clicking anywhere on a client row expands/collapses it. Backpack only
