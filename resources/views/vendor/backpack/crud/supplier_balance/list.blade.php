{{--
  Standard CRUD list, with the whole supplier row acting as the expand/collapse
  trigger for the details row (the supplier's expenses sub-list).
--}}
@extends('crud::list')
...
<style>
    ...
    .supplier-balance-subtable {
        max-height: 22rem;
        overflow-y: auto;
    }

    .supplier-balance-details .card-table th {
        position: sticky;
        top: 0;
        z-index: 1;
...
<script>
    jQuery(document).ready(function ($) {
        ...
        // Clicking anywhere on a supplier row expands/collapses it. Backpack only
